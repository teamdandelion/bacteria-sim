...
(function() {
  var ALWAYS_REPRODUCE, Blob, C, Gene, GeneCode, QTNode, QuadTree, Simulation, Vector2D, maxByIndex, minByIndex, randomSign, sim;
  ...
  C = (function() {
    ...
    C.X_BOUND = C.DISPLAY_X + 2 * C.X_MARGIN;

    C.Y_BOUND = C.DISPLAY_Y + 2 * C.Y_MARGIN;
  ...
  Blob = (function() {
    function Blob(simulation, id, energy, geneCode) {
      var _ref;
    ...
    Blob.prototype.calculateEnergyAndRadius = function() {
      ...
      this.energyPerSecond -= C.AGE_ENERGY_DECAY * this.age;
  ...
  Simulation = (function() {
    function Simulation(starting_blobs) {
      var i, _i;

      if (starting_blobs == null) {
        starting_blobs = 20;
      }
      this.blobs = {};
    ...
    Simulation.prototype.step = function() {
      ...
      for (id in _ref3) {
        blob = _ref3[id];
        _results.push(blob.wrapUp(this.location[id]));
      }
      return _results;
    };
    ...
    Simulation.prototype.addRandomBlob = function() {
      ...
      pos = Vector2D.randomBoundedVector(C.X_MARGIN, C.DISPLAY_X + C.X_MARGIN, C.Y_MARGIN, C.DISPLAY_Y + C.Y_MARGIN);
      return this.addBlob(pos, C.STARTING_ENERGY);
    };
